...
function cpsrString(val) {
  var n = (val & 0b10000000000000000000000000000000) == 0 ? '' : 'N';
  var z = (val & 0b01000000000000000000000000000000) == 0 ? '' : 'Z';
  var c = (val & 0b00100000000000000000000000000000) == 0 ? '' : 'C';
  var v = (val & 0b00010000000000000000000000000000) == 0 ? '' : 'V';
  return n + z + c + v;
}
